    ...
    >
      ...
      <NeonCard padding="sm">
        <SectionHeader
          ...
          title={<h2 className="mh-heading-lg">{mode === "bonus" ? (bundle.day.day_number === 5 || bundle.day.day_number === 6 || bundle.day.day_number === 7 ? "НВО задачи и адаптации" : "Реални задачи от НВО") : bundle.day.title}</h2>}
