...
export function LessonCard({ lesson }: LessonCardProps) {
  return (
    <article className="panel-glow rounded-[30px] p-5">
      ...
      <p className="mt-3 text-sm leading-6 text-[var(--text-muted)]">{lesson.short_theory}</p>
      <div className="mt-4 rounded-2xl border border-fuchsia-400/20 bg-fuchsia-400/8 p-4">
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-fuchsia-300">Пример</p>
