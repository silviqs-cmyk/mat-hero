          ...
          <div className="space-y-3">
            ...
            <div className="grid gap-3 xl:grid-cols-[1.2fr_0.95fr_0.95fr_0.95fr]">
              ...
              <NeonCard tone="gold" padding="sm" className="rounded-[22px]">
                <p className="text-xs font-semibold uppercase tracking-[0.12em] text-amber-300">БОНУС</p>
                <p className="mt-3 text-[1.55rem] font-semibold text-white">10 допълнителни</p>
                <div className="mt-5"><Badge tone="gold" className="w-full justify-center">За още прогрес</Badge></div>
              </NeonCard>
            </div>
          </div>
